 	    ...
 	    <div class="container" style="background-color:#FD7;coror:#000">
 	 		...
 	 		<h1 class="page-header">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<small>登録する情報を入力して下さい</small></h1><br>
        		<form class="form-horizontal" action="./addStudentServlet" method="POST">
					...
					<div class="col-sm-7"><input type="text" class="form-control" name="name" maxlength="50" required autofocus></input></div>
					<div class="col-sm-3"><p class="help-block">50文字以内で入力してください。</p></div>
					</div>

					<div class="form-group">
					<label class="col-sm-2 control-label">校種・学年:</label>
						<div class="col-sm-7"><input type="text" class="form-control" name="age" maxlength="10" placeholder="10文字以内" required> </div>
					</div>

					<div class="form-group">
					<label class="col-sm-2 control-label">ユーザーid:</label>
						<div class="col-sm-7"><input type="text" class="form-control" name="userId" maxlength="12" placeholder="12文字以内" required> </div>
					</div>

					<div class="form-group">
					<label class="col-sm-2 control-label">ユーザーパスワード:</label>
						<div class="col-sm-7"><input type="text" class="form-control" name="userPass" maxlength="12" placeholder="12文字以内" required> </div>
					</div>
