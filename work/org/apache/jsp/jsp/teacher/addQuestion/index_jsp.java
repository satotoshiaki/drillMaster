 ...
 * Generated at: 2017-07-14 01:46:53 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.jsp.teacher.addQuestion;
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write(" \t\t\t <h2 class=\"text-center\">学習問題登録</h2>\n");
      out.write("\t\t</div>\n");
      out.write("\t\t<div class=\"container\">\n");
      out.write(" \t \t\t<h1 class=\"page-header\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<small>登録する情報を入力して下さい</small></h1><br>\n");
      out.write("        \t\t<form class=\"form-horizontal\" action=\"./addQuestionServlet\" method=\"POST\">\n");
      out.write("\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t<label class=\"col-sm-2 control-label\">学習単元名:</label>\n");
      out.write("\t\t\t\t\t<div class=\"col-sm-7\"><input type=\"text\" class=\"form-control\" name=\"unitName\" maxlength=\"50\" required autofocus></div>\n");
      out.write("\t\t\t\t\t<div class=\"col-sm-3\"><p class=\"help-block\">50文字以内で入力してください。</p></div>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\n");
      out.write("\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t<label class=\"col-sm-2 control-label\">対象校種・学年:</label>\n");
      out.write("\t\t\t\t\t\t<div class=\"col-sm-7\"><input type=\"text\" class=\"form-control\" name=\"target\" maxlength=\"10\" required> </div>\n");
      out.write("\t\t\t\t\t\t<div class=\"col-sm-3\"><p class=\"help-block\">10文字以内で入力してください。</p></div>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\n");
      out.write("\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t<label class=\"col-sm-2 control-label\">問題文:</label>\n");
      out.write("\t\t\t\t\t\t<div class=\"col-sm-7\"><textarea class=\"form-control\" name=\"questionStatement\" maxlength=\"1000\" required> </textarea></div>\n");
      out.write("\t\t\t\t\t\t<div class=\"col-sm-3\"><p class=\"help-block\">1000文字以内で入力してください。</p></div>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\n");
      out.write("\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t<div class=\"col-sm-offset-2 col-sm-10 text-right\">\n");
      out.write("\t     \t    \t\t\t<button class=\"btn btn-lg btn-primary\" type=\"submit\" name=\"add\" value=\"Add\">新規登録</button>\n");
      out.write("\t     \t    \t\t</div>\n");
      out.write("\t     \t    \t</div>\n");
      out.write("\t     \t    </form>\n");
      out.write("\t     </div>\n");
